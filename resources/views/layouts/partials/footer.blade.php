      ...
      <div class="w-full lg:w-6/12 mt-8 lg:mt-0">
        <div class="flex w-full items-top mb-6">
          <div class="w-full px-4 flex flex-col items-center">
            <span class="block uppercase text-gray-600 text-sm font-semibold mb-2">{{ __('YARARLI SAYFALAR') }}</span>
            <ul class="list-unstyled">
              ...
              <li>
                <a class="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm"
                href="{{ '/' . app()->getLocale() . '/' .   trans('routes.services') }}">{{ __('Hizmetlerimiz') }}</a>
              </li>
              <li>
                <a class="text-gray-700 hover:text-gray-900 font-semibold block pb-2 text-sm"
