<footer class="relative bg-blue-pattern text-white pt-16 pb-6 lg:mt-20 mt-10">
    ...
    <div class="flex flex-wrap">
      <div class="w-full lg:w-6/12 px-4 flex flex-col items-center">
        ...
        <div class="mt-6 flex flex-row">
          ...
          <a class="bg-white text-blue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3 flex flex-col"
            type="button">
          ...
          <a class="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3 flex flex-col"
            href="https://www.instagram.com/hayatikale/">
          ...
          <a class="bg-white text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3 flex flex-col"
            type="button">
