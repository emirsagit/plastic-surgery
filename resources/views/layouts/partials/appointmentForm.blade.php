    ...
    <div class="w-screen h-full lg:w-4/5 bg-white rounded-lg p-4 lg:px-8 overflow-auto" x-data="contactForm()">
        ...
        <form method="POST" @submit.prevent="submitData">
            ...
            <div class="mb-2">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required :class="{ 'border-red-500': errors.tel }" name="tel" id="tel" type="tel" placeholder="{{ __('Telefon') }}" @keydown="errors.tel = false"
            ...
            <div class="mb-2">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{ 'border-red-500': errors.email }" name="email" id="email" type="email" placeholder="{{ __('E-Mail Address') }}"
                    @click="errors.email = false" x-model="formData.email">
            ...
            <div class="mb-2">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{ 'border-red-500': errors.date }" name="date" id="date" type="date" placeholder="{{ __('Randevu Tarihi') }}" @click="errors.date = false"
            ...
            <div class="mb-2">
                ...
                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{ 'border-red-500': errors.body }" name="body" id="body" type="text" required placeholder="{{ __('Kısaca probleminizi yazınız.') }}"
            ...
            <div class="flex items-center pb-12 lg:pb-4">
                <button id="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mb-4 disabled:opacity-50 mr-2" :disabled="loading" type="submit">
                ...
                <p @click="$parent.form = false" class="bg-gray-100 mb-4 hover:bg-gray-200 text-gray-800 py-2 px-4 cursor-pointer rounded focus:outline-none focus:shadow-outline">
                    {{ __('Geri') }}
                </p>
            </div>
        </form>
