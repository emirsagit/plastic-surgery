<form method="POST" @submit.prevent="submitData" x-data="contactForm()" class="z-20 bg-gray-800 bg-opacity-75 p-4">
    ...
    <div class="mb-2">
        ...
        <input
            ...
            required :class="{ 'border-red-500': errors.name }" name="name" id="name" type="text"
    ...
    <div class="mb-2">
        ...
        <input
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            :class="{ 'border-red-500': errors.tel }" name="tel" id="tel" type="tel" placeholder="{{ __('Telefon') }}"
            @keydown="errors.tel = false" x-model="formData.tel" required>
    ...
    <div class="mb-2">
        ...
        <textarea
            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            required :class="{ 'border-red-500': errors.body }" name="body" id="body" type="text"
    ...
    <div class="flex items-center lg:pb-4 justify-center">
        <button id="submit"
            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 mt-4 px-4 rounded focus:outline-none focus:shadow-outline mb-4 disabled:opacity-50 mr-2"
